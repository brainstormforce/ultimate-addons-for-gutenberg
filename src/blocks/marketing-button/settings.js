...
const marketingButtonSettings = props => {
    ...
    const { attributes, setAttributes, isSelected, className, deviceType } = props;
    ...
    const generalSettings = () => {
        return <PanelBody title={ __( "General", "ultimate-addons-for-gutenberg" ) } initialOpen={ true }>
                    <SelectControl
    ...
    const borderSettings = () => {
        return 	<PanelBody title={ __( "Border", "ultimate-addons-for-gutenberg" ) } initialOpen={ false }>
                    <SelectControl
