...
const InfoBoxSetting = props => {
    ...
    const imageIconPanel = () => {
        return <PanelBody	title={ __( "Image/Icon", "ultimate-addons-for-gutenberg" ) } >
                <SelectControl
    ...
    const typographySettings = () => {
        return <PanelBody	title={ __( "Content", "ultimate-addons-for-gutenberg" ) } initialOpen={ false }	>
            <ToggleControl
    ...
    const ctaSettings = () => {
        return <PanelBody	title={ __( "Call To Action", "ultimate-addons-for-gutenberg" ) } initialOpen={ false }	>
                    <SelectControl
                    ...
                    { ( ctaType !== "none" ) &&
                        <>
                            ...
                            <ToggleControl
                                ...
                                checked={ ctaTarget }
                                onChange={ ( value ) => setAttributes( { ctaTarget: ! ctaTarget } ) }
                            />
                        </>
                    } 
    ...
    return (
        <>
            {(iconimgPosition == "above-title" || iconimgPosition == "below-title" ) && blockControls() }
            <InspectorControls>
                { imageIconPanel()}
                { typographySettings() }
                { seperatorSettings() }
