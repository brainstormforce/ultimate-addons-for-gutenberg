...
const callToActionSettings = props => {
    ...
    // CTA settings.
    const ctaSettings = () => {
        return <PanelBody title={ __( "Button", "ultimate-addons-for-gutenberg" ) } initialOpen={ false }>
            <SelectControl
    ...
    const layouts = () => {
        return <PanelBody title={ __( "Layout", "ultimate-addons-for-gutenberg" ) } initialOpen={ true }>
            <SelectControl
